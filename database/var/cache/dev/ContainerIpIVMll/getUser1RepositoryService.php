 ...
 */
class getUser1RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\User1Repository' shared autowired service.
     *
     * @return \App\Repository\User1Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'User1Repository.php';

        return $container->privates['App\\Repository\\User1Repository'] = new \App\Repository\User1Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
